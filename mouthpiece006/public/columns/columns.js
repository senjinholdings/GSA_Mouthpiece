...
const columnsData = {
  mainArticle: {
    ...
    imageAlt: "マウスピース矯正の基礎知識",
    toc: [
      {
        title: "マウスピース矯正とワイヤー矯正の違い",
        id: "comparison",
        subItems: [
  ...
  sections: [
    {
      ...
      title: "マウスピース矯正とワイヤー矯正の違い",
      content: "歯列矯正には大きく分けて「マウスピース矯正」と「ワイヤー矯正」の<span style=\"background-color: #fff3cd; padding: 2px 4px;\">2種類があります</span>。それぞれの仕組みやメリット・デメリットを理解し、自分に合った治療法を選びましょう。",
      table: {
        type: "tips-comparison-table",
        headers: ["", "マウスピース矯正", "ワイヤー矯正"],
        rows: [
      ...
      additionalContent: [
        ...
        "マウスピース矯正は日常生活の制限が少なく自己管理がしやすい一方、装着時間の確保が必要です。ワイヤー矯正は適応範囲が広く、歯の大きな移動や複雑な症例にも対応できますが、見た目や清掃性の配慮が必要です。"
      ]
    },
    
    {
      ...
      title: "仕組みの違い",
      content: [
        "マウスピース矯正は<span style=\"background-color: #fff3cd; padding: 2px 4px;\">取り外し式のアライナー</span>を使い、段階的に歯を動かします。ワイヤー矯正は<span style=\"background-color: #fff3cd; padding: 2px 4px;\">固定式のブラケットとワイヤー</span>で連続的に力をかけて歯を動かします。",
        "マウスピース矯正は、1〜2週間ごとに新しいアライナーへ交換し、<span style=\"background-color: #fff3cd; padding: 2px 4px;\">段階的に目標位置へ移動</span>させます。取り外せるため、食事や歯磨きがしやすいのが特徴です。",
    ...
    
    {
      id: "merits",
      type: "highlight-box",
      title: "マウスピース矯正とワイヤー矯正のメリット・デメリット",
    ...
    
    {
      ...
      imageAlt: "マウスピース矯正の副作用について",
      content: [
        "マウスピース矯正は高い効果が期待できる一方で、治療過程での違和感や痛み、歯肉の炎症、アライナーの破損などの副作用が生じることがあります。",
    ...
    
    {
      ...
      type: "highlight-box",
      title: "起こりうる副作用",
      content: "マウスピース矯正で起こりうる主な副作用は以下の通りです。",
      subsections: [
        {
          title: "痛み・違和感",
    ...
    
    {
      ...
      title: "痛みや違和感について",
      content: [
        "マウスピース矯正の痛みや違和感は、<span style=\"background-color: #fff3cd; padding: 2px 4px;\">アライナー交換直後や歯の移動量が大きい場合に生じやすく</span>、感じ方には個人差があります。",
    ...
    
    {
      ...
      type: "highlight-box",
      title: "治療前・治療中の注意点",
      content: "マウスピース矯正の効果を最大限に引き出すため、以下の点に注意しましょう。",
      subsections: [
        {
          title: "装着時間の厳守",
      ...
      return `
          <div class="tips-merits-container">
              <div class="tips-merits-card">
                  <div class="merits-title">マウスピース矯正のメリット</div>
              ...
              <div class="tips-merits-card">
                  <div class="merits-title">マウスピース矯正のデメリット</div>
                  <ul class="merits-list">
